...
![PCO-Precision-Controllable-Offset-Surfaces-with-Sharp-Features](.pic/PCO-Precision-Controllable-Offset-Surfaces-with-Sharp-Features.png)
<td>
...
![Feature-preserving-shrink-wrapping-with-adaptive-alpha](.pic/Feature-preserving-shrink-wrapping-with-adaptive-alpha.png)
<td>
...
![Feature-Preserving-Offset-Mesh-Generation-from-Topology-Adapted-Octrees](.pic/Feature-Preserving-Offset-Mesh-Generation-from-Topology-Adapted-Octrees.png)
<td>
...
![A-Parallel-Feature-preserving-Mesh-Variable-Offsetting-Method-with-Dynamic-Programming](.pic/A-Parallel-Feature-preserving-Mesh-Variable-Offsetting-Method-with-Dynamic-Programming.png)
<td>
...
![Alpha-wrapping-with-an-offset](.pic/Alpha-wrapping-with-an-offset.png)
<td>
...
![Half-Space-Power-Diagrams-and-Discrete-Surface-Offsets](.pic/Half-Space-Power-Diagrams-and-Discrete-Surface-Offsets.png)
<td>
...
![Efficiently-computing-feature-aligned-and-high-quality-polygonal-offset-surfaces](.pic/Efficiently-computing-feature-aligned-and-high-quality-polygonal-offset-surfaces.png)
<td>
...
![Point-morphology](.pic/Point-morphology.png)
<td>
...
![Thickening-freeform-surfaces-for-solid-fabrication](.pic/Thickening-freeform-surfaces-for-solid-fabrication.png)
<td>
...
![GPU-based-offset-surface-computation-using-point-samples](.pic/GPU-based-offset-surface-computation-using-point-samples.png)
<td>
...
![Uniform-offsetting-of-polygonal-model-based-on-Layered-Depth-Normal-Images](.pic/Uniform-offsetting-of-polygonal-model-based-on-Layered-Depth-Normal-Images.png)
<td>
...
![Polygonal-Boundary-Evaluation-of-Minkowski-Sums-and-Swept-Volumes](.pic/Polygonal-Boundary-Evaluation-of-Minkowski-Sums-and-Swept-Volumes.png)
<td>
...
![Fast-Intersection-Free-Offset-Surface-Generation-From-Freeform-Models-With-Triangular-Meshes](.pic/Fast-Intersection-Free-Offset-Surface-Generation-From-Freeform-Models-With-Triangular-Meshes.png)
<td>
...
![Topology-Adaptive-Mesh-Deformation-for-Surface-Evolution,-Morphing,-and-Multiview-Reconstruction](.pic/Topology-Adaptive-Mesh-Deformation-for-Surface-Evolution,-Morphing,-and-Multiview-Reconstruction.png)
<td>
...
![Offsetting-operations-on-non-manifold-topological-models](.pic/Offsetting-operations-on-non-manifold-topological-models.png)
<td>
...
![A-Simple-Method-for-Computing-Minkowski-Sum-Boundary-in-3D-Using-Collision-Detection](.pic/A-Simple-Method-for-Computing-Minkowski-Sum-Boundary-in-3D-Using-Collision-Detection.png)
<td>
...
![Covering-Minkowski-Sum-Boundary-Using-Points-with-Applications](.pic/Covering-Minkowski-Sum-Boundary-Using-Points-with-Applications.png)
<td>
...
![Exact-Minkowski-sums-of-polyhedra-and-exact-and-efficient-decomposition-of-polyhedra-in-convex-pieces](.pic/Exact-Minkowski-sums-of-polyhedra-and-exact-and-efficient-decomposition-of-polyhedra-in-convex-pieces.png)
<td>
...
![Filleting-and-rounding-using-a-point-based-method](.pic/Filleting-and-rounding-using-a-point-based-method.png)
<td>
...
![High-Resolution-Volumetric-Computation-of-Offset-Surfaces-with-Feature-Preservation](.pic/High-Resolution-Volumetric-Computation-of-Offset-Surfaces-with-Feature-Preservation.png)
<td>
...
![Point-Based-Minkowski-Sum-Boundary](.pic/Point-Based-Minkowski-Sum-Boundary.png)
<td>
...
![Trimming-local-and-global-self-intersections-in-offset-curves/surfaces-using-distance-maps](.pic/Trimming-local-and-global-self-intersections-in-offset-curves.png)
<td>
...
![Triangular-mesh-offset-for-generalized-cutter](.pic/Triangular-mesh-offset-for-generalized-cutter.png)
<td>
...
![A-point-based-offsetting-method-of-polygonal-meshes](.pic/A-point-based-offsetting-method-of-polygonal-meshes.png)
<td>
...
![Accurate-Minkowski-sum-approximation-of-polyhedral-models](.pic/Accurate-Minkowski-sum-approximation-of-polyhedral-models.png)
<td>
...
![Offset-Triangular-Mesh-Using-the-Multiple-Normal-Vectors-of-a-Vertex](.pic/Offset-Triangular-Mesh-Using-the-Multiple-Normal-Vectors-of-a-Vertex.png)
<td>
...
![Self-intersection-Removal-in-Triangular-Mesh-Offsetting](.pic/Self-intersection-Removal-in-Triangular-Mesh-Offsetting.png)
<td>
...
![A-new-curve-based-approach-to-polyhedral-machining](.pic/A-new-curve-based-approach-to-polyhedral-machining.png)
<td>
...
![A-computing-strategy-for-applications-involving-offsets,-sweeps,-and-Minkowski-operations](.pic/A-computing-strategy-for-applications-involving-offsets,-sweeps,-and-Minkowski-operations.png)
<td>
...
![Generating-Shaded-Offset-Surfaces-with-Distance,-Closest-Point-and-Color-Volumes](.pic/Generating-Shaded-Offset-Surfaces-with-Distance,-Closest-Point-and-Color-Volumes.png)
<td>
...
![Offsetting-operations-on-non-manifold-boundary-representation-models-with-simple-geometry](.pic/Offsetting-operations-on-non-manifold-boundary-representation-models-with-simple-geometry.png)
<td>
...
![Intersection-of-offsets-of-parametric-surfaces](.pic/Intersection-of-offsets-of-parametric-surfaces.png)
<td>
